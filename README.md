...
| **Отклонить релиз** | С причиной, которую увидит артист. Причину можно пропустить, но лучше не надо. |
...
- **Отмена** — после решения всплывает «Отменить», релиз возвращается в очередь
  целиком.
- **Каталог, артисты, плейлисты, станция** — просмотр, снятие с публикации,
  сборка кураторских миксов, сводка.
