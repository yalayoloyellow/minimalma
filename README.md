...
- В карточке — обложка, трек-лист и метаданные. Каждый трек играется прямо
  там, ничего скачивать не надо.
- Опубликовать, отклонить с причиной, перетегировать, написать заметку,
  поправить метаданные, приложить обложку.
- Никаких оценок качества и технических ярлыков: решение принимается на слух.
  Нравится, как звучит, — значит подходит.
...
- **Очередь** — релизы слева, карточка справа: обложка, заметка, метаданные и
  все треки, каждый со своим плеером. Слушать можно сразу, ничего не скачивая
  руками.
